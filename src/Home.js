...
<div className=" p-2 flex bg-[#253439]">
        <div className="w-2/4 ">
          <img src="https://images.pexels.com/photos/220453/pexels-photo-220453.jpeg?auto=compress&cs=tinysrgb&dpr=1&w=500" alt="Girl in a jacket" className="inset-y-1/4 left-[300px]  absolute mx-auto rounded-full w-[240px] h-[240px] object-cover"/>
          <div className="mx-auto flex justify-center absolute inset-y-2/4 left-[310px]">
      ...
      <div className="px-2 py-12 relative">
        ...
        <div className="flex"><hr className="my-12 w-24 opacity-70 mt-[12px] mr-8 "/><h1 className="text-white secHeader text-white opacity-70">Check Out My Skills</h1></div>
            <div className="flex my-16 but text-[#F6F4F1] text-sm"> 
            ...
            <div className="flex place-content-center mt-36">    
